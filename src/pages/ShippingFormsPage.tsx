...
import { TrashIcon, ShareIcon, DownloadIcon } from '../components/icons';
                    ...
                    <CardContent className="p-4">
                        <div className="flex flex-col lg:flex-row items-center justify-between gap-4">
                            ...
                            <div className="relative flex-grow w-full lg:max-w-2xl group">
                                <Button onClick={handleLoadDataFromShipment} className="absolute top-1.5 right-1.5 bottom-1.5 z-10" disabled={!shipmentId}>
                                    {t('loadFromShipment')}
                                </Button>
                                <Input 
                                    value={shipmentId} 
                                    ...
                                    className="w-full bg-white pr-32"
                                />
                            </div>
                            ...
                            <div className="flex items-center gap-2 bg-white p-1.5 rounded-xl border border-blue-100 shadow-sm w-full lg:w-auto justify-end">
                                ...
                                {canShare && (
                                    <Button onClick={handleShare} variant="ghost" size="icon" className="text-blue-600 hover:bg-blue-50 rounded-lg w-10 h-10" title={t('share')}>
