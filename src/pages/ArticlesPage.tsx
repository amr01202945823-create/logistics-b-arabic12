        ...
        <div className="animate-fade-in pb-20">
            ...
            <div className="max-w-6xl mx-auto px-4">
                ...
                <div className="flex justify-between items-center mb-6">
                    <Button onClick={onBack} variant="ghost" className="hover:bg-gray-100 dark:hover:bg-slate-800 text-gray-600 dark:text-gray-300 pl-0">
                        {/* Fix: In Arabic (RTL), Back button should point Right (rotate-180). In English (LTR), it should point Left (default). */}
                        <ArrowLeftIcon className={`w-5 h-5 ${language === 'ar' ? 'rotate-180 ml-2' : 'mr-2'}`} />
                        {t('back')}
                    </Button>
                ...
                {/* Hero Section */}
                <div className="relative rounded-3xl overflow-hidden shadow-2xl mb-10 h-[350px] md:h-[450px]">
                    <img 
                    ...
                    <div className="absolute bottom-0 left-0 w-full p-6 md:p-12">
                        ...
                        <h1 className={`text-2xl md:text-5xl font-extrabold text-white leading-tight max-w-4xl drop-shadow-lg ${language === 'ar' ? 'font-cairo' : 'font-inter'}`}>
                    ...
                    <div className="grid lg:grid-cols-12 gap-8 lg:gap-12">
                            ...
                            <Card className="bg-white dark:bg-slate-900 border-none shadow-sm overflow-hidden">
                                <CardContent className="p-6 md:p-10">
                                    ...
                                    <div className="flex items-center gap-4 mb-8 pb-8 border-b border-gray-100 dark:border-slate-800">
                                        <div className="w-12 h-12 rounded-full bg-blue-100 dark:bg-slate-800 flex items-center justify-center text-blue-600 dark:text-blue-400 font-bold text-lg flex-shrink-0">
                                            LB
                                        </div>
                                        <div>
                                            <div className="font-bold text-gray-900 dark:text-white">{t('editorialTeam')}</div>
                                            <div className="text-sm text-gray-500">{t('marketIntelligence')}</div>
                                        </div>
                                    </div>

                                    <div className="prose dark:prose-invert max-w-none text-gray-700 dark:text-gray-300 text-base md:text-lg leading-relaxed prose-headings:font-bold prose-headings:text-gray-900 dark:prose-headings:text-white prose-a:text-blue-600 prose-img:rounded-xl">
                                        <ReactMarkdown>
                        ...
                        <div className="lg:col-span-4 space-y-8">
                            <div className="sticky top-24">
                                <div className="mb-6">
                                    <h3 className={`font-bold text-xl text-gray-900 dark:text-white mb-6 border-primary ${language === 'ar' ? 'border-r-4 pr-3' : 'border-l-4 pl-3'}`}>
                                        {t('youMightLike')}
                                    </h3>
                                        ...
                                        {relatedArticles.map((relArt) => (
                                            ...
                                            >
                                                ...
                                                <div className="flex-1 min-w-0 py-1">
                                                    ...
                                                    <h4 className="font-bold text-sm text-gray-800 dark:text-gray-200 line-clamp-2 leading-snug group-hover:text-primary transition-colors">
                                ...
                                <div className="p-6 bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl text-white text-center shadow-lg shadow-blue-900/20">
                                    <h4 className="font-bold text-lg mb-2">{t('weeklyLogisticsBrief')}</h4>
                                    <p className="text-blue-100 text-sm mb-6 leading-relaxed">{t('getMarketUpdates')}</p>
                                    <Button className="w-full bg-white text-blue-700 hover:bg-blue-50 font-bold border-none shadow-md transition-transform hover:-translate-y-0.5">{t('subscribe')}</Button>
                                </div>
                            </div>
                        </div>
                    </div>
