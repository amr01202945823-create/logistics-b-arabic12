...
export const TermsPage: React.FC = () => {
    ...
    const arabicContent = (
        <div className="prose prose-slate max-w-none text-right" dir="rtl">
            ...
            <p>مرحباً بك في <strong>Logistics B Arab</strong>. بمجرد استخدامك لهذا الموقع/التطبيق، فإنك توافق على الالتزام بالشروط والأحكام التالية. إذا كنت لا توافق على أي من هذه البنود، يرجى التوقف عن استخدام خدماتنا.</p>
            ...
            <p>جميع المحتويات الموجودة على هذا الموقع/التطبيق (بما في ذلك النصوص، الشعارات، الصور، البرمجيات) هي ملكية حصرية لـ <strong>Logistics B Arab</strong> ومحمية بموجب قوانين الملكية الفكرية. يُمنع نسخ أو إعادة نشر أو توزيع أي جزء من المحتوى دون إذن كتابي مسبق.</p>
            ...
            <h3>5. التعويض</h3>
            <p>أنت توافق على تعويض <strong>Logistics B Arab</strong> ومدرائه وموظفيه عن أي خسائر أو أضرار أو نفقات (بما في ذلك الرسوم القانونية) تنشأ عن مخالفتك لهذه الشروط أو إساءة استخدامك للخدمة.</p>
    ...
    const englishContent = (
        <div className="prose prose-slate max-w-none text-left" dir="ltr">
            ...
            <p>Welcome to <strong>Logistics B Arab</strong>. By using this website/application, you agree to comply with the following terms and conditions. If you do not agree with any of these terms, please stop using our services.</p>
            ...
            <p>All content on this website/application (including text, logos, images, software) is the exclusive property of <strong>Logistics B Arab</strong> and is protected by intellectual property laws. Copying, republishing, or distributing any part of the content without prior written permission is prohibited.</p>
            ...
            <p>You agree to indemnify <strong>Logistics B Arab</strong>, its directors, and employees against any losses, damages, or expenses (including legal fees) arising from your violation of these terms or misuse of the service.</p>
