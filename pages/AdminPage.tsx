...
import { 
    ...
    CurrencyDollarIcon, XIcon, DownloadIcon, TagIcon, EyeIcon, PhoneIcon, EnvelopeIcon, GlobeAltIcon
    ...
    return (
        <form onSubmit={(e) => { e.preventDefault(); onSubmit(formData, true); }} className="space-y-6 max-h-[70vh] overflow-y-auto pr-2 custom-scrollbar">
            ...
            <div className="space-y-4">
                <h4 className="font-bold text-sm text-gray-500 uppercase border-b pb-2">Basic Details</h4>
